...
*Data and analysis scripts: `integrated_dataset/` and `analysis/` in the Sand
Database repository. Figures generated by `analysis/01_statistics.py`. Each
material file cites its original data sources; see `references.csv`.*
